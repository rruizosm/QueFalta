 ...
 *  la API de Carrefour va por el espejo en Supabase). Sin favoritos por ahora: los
 *  ids de Carrefour no se distinguen de los de Mercadona (ver retailerOf). */
export default function CarrefourProductModal({ product, onClose }: Props) {
  ...
  return (
    <View style={styles.overlay}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        {product.pricePerUnit ? <Text style={styles.refPrice}>{product.pricePerUnit} / ud. de medida</Text> : null}
        ...
        <Text style={styles.note}>Producto de Carrefour</Text>
      </ScrollView>
