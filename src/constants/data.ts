...
export const GROUPS: Group[] = [
  {
    ...
    members: [
      { id: 'm1', name: 'Rubén', initials: 'RU', color: '#2f9e44', isAdmin: true },
      { id: 'm2', name: 'María', initials: 'MA', color: '#1971c2', isAdmin: false },
      { id: 'm3', name: 'Carlos', initials: 'CA', color: '#e8590c', isAdmin: false },
      { id: 'm4', name: 'Laura', initials: 'LA', color: '#9c36b5', isAdmin: false },
    ],
    activity: [
  ...
  },
  {
    ...
    members: [
      { id: 'm1', name: 'Rubén', initials: 'RU', color: '#2f9e44', isAdmin: true },
      { id: 'm5', name: 'Leo', initials: 'LE', color: '#f08c00', isAdmin: false },
      { id: 'm6', name: 'Ana', initials: 'AN', color: '#e03131', isAdmin: false },
      { id: 'm7', name: 'Pedro', initials: 'PE', color: '#0c8599', isAdmin: false },
      { id: 'm8', name: 'Noe', initials: 'NO', color: '#9c36b5', isAdmin: false },
      { id: 'm9', name: 'Sara', initials: 'SA', color: '#e8590c', isAdmin: false },
    ],
    activity: [
  ...
  },
  {
    ...
    members: [
      { id: 'm1', name: 'Rubén', initials: 'RU', color: '#2f9e44', isAdmin: true },
      { id: 'm2', name: 'María', initials: 'MA', color: '#1971c2', isAdmin: false },
      { id: 'm10', name: 'Jorge', initials: 'JO', color: '#0c8599', isAdmin: false },
    ],
    activity: [],
  },
  {
