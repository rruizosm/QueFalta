-- Permite que PostgreSQL use los índices FTS/trigram de cada idioma. La función
-- v1 elegía display_name_norm con un CASE parametrizado; el resultado era
-- correcto, pero el plan genérico no podía asociar esa expresión con el índice.
