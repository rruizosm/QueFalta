...
export default function HiperdinoProductModal({ product, onClose, topInset = 16 }: Props) {
  ...
  return (
    <View style={styles.overlay}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <SimilarProductsSection productName={product.displayName} excludeStore="hiperdino" />
