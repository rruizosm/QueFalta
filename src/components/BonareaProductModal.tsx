...
import type { BonareaProduct } from '../api/catalog';
 ...
 *  el catálogo de bonÀrea va por el espejo en Supabase). Sin favoritos por ahora: los
 *  ids de bonÀrea ("13*5304") no se integran aún con retailerOf. */
  ...
  return (
    <View style={styles.overlay}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.note}>Producto de bonÀrea</Text>
      </ScrollView>
