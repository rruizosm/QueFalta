# Ficha de Google Play — QuéFalta

> Contenido preparado para Google Play Console. Paquete `com.quefalta.app`,
> versión `1.2.0`. Idiomas: Español (España) primario + Catalán.

## 1) Ficha principal

| Campo | Valor |
|---|---|
| **Nombre de la aplicación** | `QuéFalta` |
| **Categoría** | **Compras** |
| **Correo de contacto** | `rruizosma@gmail.com` |
| **Web** | `https://quefalta.es` |
| **Política de privacidad** | `https://quefalta.es/privacidad` |

### Descripción breve (máximo 80 caracteres)

**es-ES:**
```
Compara precios y ofertas, consulta el Índice alimentario y comparte tu cesta
```

**ca-ES:**
```
Compara preus i ofertes, consulta l’Índex alimentari i comparteix la cistella
```

### Descripción completa (máximo 4.000 caracteres)

**es-ES:**
```
Organiza la compra en grupo y consulta catálogos con productos, precios y promociones de 15 supermercados desde una sola aplicación.
...
Consulta productos y precios de 15 supermercados, busca por categorías y elige entre vista de lista o cuadrícula.
...
**ca-ES:**
```
Organitza la compra en grup i consulta catàlegs amb productes, preus i promocions de 15 supermercats des d’una sola aplicació.
...
Consulta productes i preus de 15 supermercats, cerca per categories i tria entre la vista de llista o quadrícula.
...
## 2) Notas de la versión 1.2

> Google Play admite un máximo de 500 caracteres Unicode por idioma. El bloque
> siguiente está preparado para pegarse directamente en “Novedades de esta
> versión”.
...
## 3) Recursos gráficos de la ficha

- **Icono de Play Store:** PNG de 512 × 512 px, máximo 1 MB.
- **Imagen destacada:** JPEG o PNG de 24 bits, sin transparencia, 1024 × 500 px.
- **Imagen destacada preparada:** `marketing/google-play/feature-graphic-1024x500.png`
  (PNG RGB de 24 bits, 1024 × 500 px, 0,759 MB).
- **Texto alternativo:** `Cesta de la compra con productos, lista compartida,
  ofertas, cambios de precio e Índice alimentario de QuéFalta.`
- **Capturas de teléfono:** mínimo 2; JPEG o PNG de 24 bits, entre 320 y 3840 px.
- Localizar la imagen destacada y cualquier texto superpuesto en castellano y
  catalán.

## 4) Pendientes antes de publicar

- [ ] Pegar y guardar las dos traducciones de la ficha principal.
- [ ] Subir una imagen destacada de 1024 × 500 px.
- [ ] Subir capturas actuales de la aplicación Android.
- [ ] Completar Seguridad de los datos y el cuestionario de contenido.
- [ ] Comprobar que `https://quefalta.es/privacidad` y la página de eliminación
      de cuenta son públicas.
- [ ] Añadir las notas localizadas al crear la versión 1.2.
- [ ] Seleccionar el AAB de producción y desplegar primero en el canal de prueba
      correspondiente.
